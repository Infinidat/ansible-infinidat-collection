...
## Galaxy API
The Makefile assumes there is a file defining an API_KEY. The key may be found at https://galaxy.ansible.com/ui/token/. This file should be sourced so as to define $API_KEY.
```
